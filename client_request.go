...
func (d *DAC) MakeRequest(
	...
	d.le.Debugf("making request: %s", gcm.EGCDACClientMessages(reqMsgID).String())
...
func (d *DAC) handleResponsePacket(le *logrus.Entry, packet *gamecoordinator.GCPacket) (handled bool) {
	d.pendReqMtx.Lock()
